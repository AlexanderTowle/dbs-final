...
select c.first_name, c.last_name, s.street, s.city, s.state, s.zip, t.transaction_date, p.product_id, p.base_price, 
...
group by c.customer_id, t.transaction_num, p.product_id;
